...
StringCaseSense, Locale
	...
	mail 			:= new Yandex
	searchWords 	:= mail.FFWordExtract(abbyyshot, "Введите ключевое слово:", "»",  "«", "non")
	sear 			:= mail.FFSEextract(abbyyshot, "Введите ключевое слово:", "Откройте страницу ", 1)
	...
	mail.messagebox("Open one Random web site")
